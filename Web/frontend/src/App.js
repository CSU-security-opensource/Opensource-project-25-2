...
import KakaoMap from "./KakaoMap"; // 지도 컴포넌트 불러오기
import {
  Sun,
  Cloud,
  Thermometer,
...
function App() {
  ...
  const [isMapOpen, setIsMapOpen] = useState(false); // 지도 팝업 상태 관리
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 p-4">
      ...
      {isMapOpen && (
        <div 
          ...
          onClick={() => setIsMapOpen(false)} // 배경 누르면 닫기
        >
          <div 
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-blue-700 underline decoration-blue-300 underline-offset-4">경기도 김포시 월곶면</span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto mt-8 pb-4">
        <div className="flex items-center justify-between text-sm text-gray-500">
          ...
          <span>마지막 업데이트: 2025년 12월 18일 14:32</span>
